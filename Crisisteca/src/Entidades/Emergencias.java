...
public class Emergencias {
	...
	public Emergencias(Integer eCodigoPostal, String eCalleYNumero, String eTipoEmergencia, Integer eUsuario,
			boolean eReportar, String eDetalles, String eFechaYHora) {
	...
	/*
	 * return: eReportar (Valor booleano que indica si se desea reportar la
	 * emergencia o no)
	 */
	...
	/*
	 * return: eDetalles (String con detalles sobre la emergencia que el usuario
	 * quiera añadir)
	 */
	...
	/*
	 * return: eFechaYHora ( La fecha y la hora a la que se ha reportado la
	 * emergencia)
	 */
	...
	public String toString() {
		return "Emergencias [eCodigoPostal=" + eCodigoPostal + ",eCalleYNumero=" + eCalleYNumero + " , eTipoEmergencia="
				+ eTipoEmergencia + ", eUsuario=" + eUsuario + ", eReportar=" + eReportar + ", eDetalles=" + eDetalles
				+ ", eFechaYHora = " + eFechaYHora + "]";
	}
}
